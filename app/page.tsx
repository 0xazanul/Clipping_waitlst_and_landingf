      ...
      <footer className="w-full border-t border-white/[0.05] mt-12 sm:mt-16 md:mt-20 lg:mt-32">
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 sm:py-12 md:py-16 lg:py-20 flex flex-col items-center gap-6 sm:gap-8 md:gap-10">
          <a
            ...
            className="group inline-flex items-center gap-2 sm:gap-2.5 text-gray-400 hover:text-white transition-colors duration-200"
          >
            <svg
            ...
            <span className="font-light text-xs sm:text-sm tracking-wide">Join Discord</span>
          </a>
          ...
          <p className="text-gray-700 font-light text-[10px] sm:text-xs tracking-wide">
